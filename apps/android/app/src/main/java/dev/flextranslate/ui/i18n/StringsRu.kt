...
/** Русские тексты интерфейса. Дословно повторяют исходные захардкоженные строки. */
...
/** Держит русские тексты по каждому облачному провайдеру (заголовок/роль/раскрытие). */
